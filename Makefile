...
FILES	= main/errors main/utils main/signals main/vi_mode					\
		...
		builtins/unalias builtins/alias builtins/fc							\
		...
		expanding/condition	expanding/arith_utils expanding/arith_ops		\
		expanding/arith_parse												\
